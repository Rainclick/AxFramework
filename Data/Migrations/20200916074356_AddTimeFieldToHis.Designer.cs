...
namespace Data.Migrations
{
    ...
    [Migration("20200916074356_AddTimeFieldToHis")]
    partial class AddTimeFieldToHis
    {
            ...
            modelBuilder.Entity("Entities.Tracking.ProductInstance", b =>
                {
                    ...
                    b.HasOne("Entities.Tracking.Personnel", "Personnel")
                        .WithOne()
                        .HasForeignKey("Entities.Tracking.ProductInstance", "PersonnelId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Entities.Tracking.ProductLine", "ProductLine")
                        .WithOne()
                        .HasForeignKey("Entities.Tracking.ProductInstance", "ProductLineId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
